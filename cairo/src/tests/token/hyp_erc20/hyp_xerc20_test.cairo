use hyperlane_starknet::contracts::mocks::xerc20_test::{
...
use super::common::{
    ...
    DESTINATION, IHypERC20TestDispatcher, IHypERC20TestDispatcherTrait,
...
fn setup() -> Setup {
    ...
    setup.primary_token = ITestERC20Dispatcher { contract_address: primary_token };
    println!("XERC20Test: {:?}", primary_token);
