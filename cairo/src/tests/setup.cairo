...
use snforge_std::{
    declare, ContractClassTrait, EventSpyAssertionsTrait, spy_events, DeclareResultTrait, EventSpy
};
...
pub fn setup_protocol_fee() -> (IProtocolFeeDispatcher, IPostDispatchHookDispatcher) {
    let protocol_fee_class = declare("protocol_fee").unwrap().contract_class();
