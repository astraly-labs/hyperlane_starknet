...
pub mod checkpoint_lib {
    ...
    pub trait CheckpointLib {
        fn digest(_origin: u32, _origin_merkle_tree_hook: u256, _checkpoint_root: u256, _checkpoint_index: u32, _message_id: u256) -> u256;
        fn domain_hash(_origin: u32, _origin_merkle_tree_hook: u256) -> u256 ;
    }
    const HYPERLANE: felt252 = 'HYPERLANE';
    const ETH_SIGNED_MESSAGE: felt252 = '\x19Ethereum Signed Message:\n';
