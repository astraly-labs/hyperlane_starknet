//! Modified from
//! {https://github.com/0xHashstack/hashstack_contracts/blob/main/src/token/erc4626/erc4626component.cairo}
...
pub mod ERC4626Component {
    ...
    pub struct Storage {
        ...
        pub ERC4626_underlying_decimals: u8,
        pub ERC4626_offset: u8,
    }
